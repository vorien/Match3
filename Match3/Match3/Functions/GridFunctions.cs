...
namespace Match3.Functions
{
    public static class GridFunctions
    {
        ...
        //public static CCPoint GridToPoint(int column, int row) {
        //    CCPoint newPosition = new CCPoint();
        //    CCSize spriteDimensions = ActiveLevel.grid[column, row].spriteSize;
        //    newPosition = new CCPoint((spriteDimensions.Width * (column + .5f)), spriteDimensions.Height * (row + .5f));
        //    return newPosition;
        //}
    ...
    //    public static Candy GetCandyAt(int row, int column)
    //    {
    ...
    //    //public static async void TrySwap(Candy fromCandy, CCPointI toCandyOffset)
    //    //{
    //    //    if (toCandyOffset == new CCPointI(0, 0))
    //    //    {
    //    //        return;
    //    //    } else {
    //    //        if (!HasCandy(fromCandy.gridLocation + toCandyOffset))
    //    //        {
    //    //            return;
    //    //        }
    //    //    }
    //    //    //Candy toCandy = GetCandyAt(toRow, toCol);
    //    //    //Candy fromCandy = GetCandyAt(fromRow, fromCol);
    //    //    //debugLabel.Text = "Switching candy at [" + fromRow + ", " + fromCol + "] with candy at [" + toRow + ", " + toCol + "].";

    //    //    Swap swap = new Swap();
    //    //    swap.candyA = fromCandy;
    //    //    swap.candyB = GetCandyAtOffset(fromCandy, toCandyOffset);
    ...
    //    private static void AnimateSwap(Swap swap)
    //    {
    ...
    //        swap.candyA.SetCandyPosition(ConvertYToRow(positionB.Y), ConvertXToColumn(positionB.X));
    //        swap.candyB.SetCandyPosition(ConvertYToRow(positionA.Y), ConvertXToColumn(positionA.X));

    //        //  Update the position of the candies within the grid
    //        ActiveLevel.grid[swap.candyA.GetCandyRow(), swap.candyA.GetCandyColumn()] = swap.candyA;
    //        ActiveLevel.grid[swap.candyB.GetCandyRow(), swap.candyB.GetCandyColumn()] = swap.candyB;
    //    }
    ...
    //    private static int ConvertYToRow(float y)
    //    {
    //        return (846 - Convert.ToInt32(y)) / 70;
    //    }

    //    //  Get the column from the X location
    //    private static int ConvertXToColumn(float x)
    //    {
